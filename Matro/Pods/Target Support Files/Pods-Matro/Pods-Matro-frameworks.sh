...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Matro/AFNetworking_Synchronous.framework"
  install_framework "Pods-Matro/Base64nl.framework"
  install_framework "Pods-Matro/DWTagList.framework"
  ...
  install_framework "Pods-Matro/Masonry.framework"
  ...
  install_framework "Pods-Matro/ZBarSDK.framework"
fi
